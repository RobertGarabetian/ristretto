...
// Authentication middleware with added logging
func middlewareAuth(next http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if !ok || !token.Valid {
			log.Println("ERROR: Failed to extract claims or token is invalid")
...
// Verify Clerk JWT token with added logging
...
// ensureUserExists with added logging
...
// getCoffeeShops with added logging
